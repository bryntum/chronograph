...
// import {ChronoGraphNode, ChronoMutationNode, MinimalChronoMutationNode} from "./Node.js";
//
//
// //
...
//
//
// export const MinimalChronoGraphSnapshot = ChronoGraphSnapshot(ChronoGraphNode(Graph(VersionedReference(Reference(Immutable(HasId(Node(Observer(ObservedBy(Writable(Readable(Atom(Base)))))))))))))
