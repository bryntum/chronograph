...
// import { FieldAtom, FieldAtomConstructor } from "./Atom.js"
//
// //---------------------------------------------------------------------------------------------------------------------
// /**
...
//
//     identifierCls       : FieldAtomConstructor    = MinimalReferenceBucketIdentifier
...
//     [ FieldAtom ],
//     (base : AnyConstructor<FieldAtom, typeof FieldAtom>) => {
...
//
// //---------------------------------------------------------------------------------------------------------------------
// export class MinimalReferenceBucketIdentifier extends ReferenceBucketIdentifier.mix(FieldAtom.mix(CalculatedValueSync)) {}
