...
//     identifierCls       : FieldAtomConstructor    = MinimalReferenceIdentifier
//
...
//
//
// export class MinimalReferenceIdentifier extends ReferenceIdentifier.mix(FieldAtom.mix(CalculatedValueSync)) {}
