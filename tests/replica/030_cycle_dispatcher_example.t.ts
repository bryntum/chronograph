...
import { Formula, CycleDescription, CycleResolution } from "../../src/cycle_resolver/CycleResolver.js"
...
//---------------------------------------------------------------------------------------------------------------------
export class CycleDispatcher extends CycleResolutionInputChrono {

    addInstruction (instruction : Instruction) {
        if (instruction === Instruction.KeepStart) this.addKeepIfPossibleFlag(StartDateVar)
        if (instruction === Instruction.KeepEnd) this.addKeepIfPossibleFlag(EndDateVar)
