...
// import { ChronoAtom, ChronoAtomI } from "./Atom.js"
...
//     onEffect        : (effect : Effect) => any                  = () => null
// }
//
//
// export class AsyncPropagationContext extends PropagationContext {
//     onEffect        : (effect : Effect) => Promise<any>         = async () => null
// }
//
//
// //---------------------------------------------------------------------------------------------------------------------
...
//
//
//     switchTo (revision : RevisionNode) {
//
//     }
//
//
//     undo () {
//         const incoming          = this.currentRevision.incoming
...
//
//     redo () {
//         const outgoing          = this.currentRevision.outgoing
//         const outgoingSize      = outgoing.size
//
//         if (outgoingSize === 0) {
//             return
//         }
//         else if (outgoingSize === 1) {
//             this.switchTo(outgoing.keys()[ 0 ])
//         } else {
//             throw new Error("Not supported yet")
//         }
//     }
