...
//
// //---------------------------------------------------------------------------------------------------------------------
// export const Transaction = <T extends AnyConstructor<Node & ChronoCalculation>>(base : T) =>
//
...
//
//
//     addProposedQuark (quark : QuarkI, args? : any[]) {
//         this.addEdgeFrom(quark, args)
//     }
//
//
//     getProposedDataFor (quark : QuarkI) {
//         return this.incoming.get(quark)
//     }
//
//
//     close () {
...
// }
//
// export class MinimalTransaction extends Transaction(ChronoCalculation(Box(MinimalNode))) {
//     YieldT                  : GraphCycleDetectedEffect
//     ValueT                  : TransactionPropagation
// }
